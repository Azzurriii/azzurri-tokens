...
contract INO is Ownable {
    ...
    function randomLevel() internal returns (uint256) {
        ...
        if (randomValue < level.maxLevel1) return 1;
            ...
            level.maxLevel1 <= randomValue && randomValue < level.maxLevel2
        ) return 2;
        else if (
            level.maxLevel2 <= randomValue && randomValue < level.maxLevel3
        ) return 3;
        else if (
            level.maxLevel3 <= randomValue && randomValue < level.maxLevel4
        ) return 4;
        else if (
            level.maxLevel4 <= randomValue && randomValue < level.maxLevel5
        ) return 5;
        else if (
            level.maxLevel5 <= randomValue && randomValue < level.maxLevel6
        ) return 6;
        else if (
            level.maxLevel6 <= randomValue && randomValue < level.maxLevel7
        ) return 7;
        else if (
            level.maxLevel7 <= randomValue && randomValue < level.maxLevel8
        ) return 8;
        else if (
            level.maxLevel8 <= randomValue && randomValue < level.maxLevel9
        ) return 9;
        else if (
            level.maxLevel9 <= randomValue && randomValue < level.maxLevel10
        ) return 10;
        else return 1;
    }
}
